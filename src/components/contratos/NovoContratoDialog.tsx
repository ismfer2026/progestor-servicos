  ...
  const handleSalvar = async () => {
    ...
    try {
      ...
      if (modelo && !modelo.conteudo_template && modelo.file_url) {
        ...
        // Mantém o comportamento atual (modelo do tipo template)
        conteudoContrato = modelo?.conteudo_template || "";
      }
          ...
          <div className="space-y-4">
                    ...
                    <TableBody>
                      {servicos.map((servico, index) => (
                        <TableRow key={index}>
                          ...
                          <TableCell>
                            <Button variant="ghost" size="sm" onClick={() => removeServico(index)}>
                              <X className="h-4 w-4" />
                            </Button>
                          </TableCell>
                        </TableRow>
                      ...
                      <TableRow>
                        ...
                        <TableCell className="font-bold text-primary">R$ {calcularValorTotal().toFixed(2)}</TableCell>
                        <TableCell></TableCell>
                      </TableRow>
                    </TableBody>
                  </Table>
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-2">
                <Input placeholder="Rua" value={enderecoRua} onChange={(e) => setEnderecoRua(e.target.value)} />
                <Input
                  placeholder="Número"
            ...
            <div>
              ...
              <div className="border rounded-lg p-4 space-y-4">
                ...
                <div className="p-3 bg-muted rounded-lg">
                  ...
                  <p className="text-xl font-bold">R$ {(calcularValorTotal() - valorSinal).toFixed(2)}</p>
                </div>

                <div>
                  <Label htmlFor="numeroParcelas">Número de Parcelas</Label>
                  <Select value={numeroParcelas.toString()} onValueChange={(value) => setNumeroParcelas(Number(value))}>
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                    ...
                    <Table>
                      ...
                      <TableBody>
                        {parcelas.map((parcela, index) => (
                          <TableRow key={index}>
                            <TableCell>
                              Parcela {parcela.numero}/{numeroParcelas}
                            </TableCell>
                            <TableCell>
                              <Input
                                type="number"
